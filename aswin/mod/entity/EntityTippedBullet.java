...
public class EntityTippedBullet extends EntityBullet {
    ...
    public EntityTippedBullet(World worldIn)
    {
        super(worldIn);
    }

    public EntityTippedBullet(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }

    public EntityTippedBullet(World worldIn, EntityLivingBase shooter)
    {
